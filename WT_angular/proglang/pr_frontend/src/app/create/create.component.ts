    ...
    this.form = this.fb.group(
      {
        ...
        jahrControl: ['Jahr', Validators.required],
        lizenzControl: ['Lizenz', Validators.required],
      }
    );
  }
...
/*     this.id = this.route.snapshot.paramMap.get('id') || '';
  ...
  //(2c) aufruf durch ngsubmit --> hinzufügen-button in .html
  create(): void {

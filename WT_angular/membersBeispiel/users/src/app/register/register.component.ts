...
export class RegisterComponent {
  ...
  //(4) group-fkt von formbuilder (in constructor definiert) <group demnächst deprecated>
  // mit versch. form controls (felder)
  registerForm = this.fb.group({
    // validators kontrollieren korrektheit der eingaben, details bei hover
